...
画法：左侧输入，中间原创淘气小孩或怪机器处理，右侧输出，橙色箭头表达主流向。

### 系统局部

适合：信息来源、过滤器、数据库、渲染器、agent 系统局部。

画法：只画 3-5 个核心模块，原创淘气小孩参与其中一个关键动作。
...
画法：一层层盒子，不要正式金字塔；原创淘气小孩在旁边搬砖、搭积木或涂鸦搭建。

### 地图路线

适合：从想法到上线、用户路径、内容承接路径、学习路线。

画法：一条弯曲路径，少量节点，原创淘气小孩牵线、拖玩具车或用蜡笔画路。
...
3. 让原创淘气小孩承担动作：不是站旁边，而是卡在机器里、拉错线、守门、搬运、涂鸦修补、称重、扶梯子、记录、把东西塞进某个怪装置。
...
- 拉、扛、塞、捞、压、称、缝、剪、拧、守、推、接、拆、标记、回收、涂鸦、搭积木、按按钮、背书包、拿放大镜。
- 动作要服务核心意思，不要为了怪而怪。
...
同类主题也要换新隐喻。例如“承接路径”不一定画路线，可以画原创淘气小孩把内容尾巴接到门把手；“一鱼多吃”不一定画鱼，可以画角色把一个纸团压成几种形状。
